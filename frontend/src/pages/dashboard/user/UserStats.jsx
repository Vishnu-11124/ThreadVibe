    ...
    <div>
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
            ...
            <p className="text-3xl font-extrabold text-gray-900">${stats.totalPaymentAmount}</p>
        </div>
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
            ...
            <p className="text-3xl font-extrabold text-gray-900">${stats.totalPurchasedProducts}</p>
        </div>
      </div>
    </div>
  )
